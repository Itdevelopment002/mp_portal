...
const Sidebar = () => {
  ...
  const [selectedItem, setSelectedItem] = useState(null);
    ...
    const handleClickOutside = (event) => {
        if (sidebarRef.current && !sidebarRef.current.contains(event.target)) {
            // Check if the sidebar is open and then hide it
    ...
    const handleSidebarItemClick = (item) => {
      ...
      const sidebarElement = document.getElementById("sidebarMenu");
      if (sidebarElement && sidebarElement.classList.contains("show")) {
          sidebarElement.classList.remove("show"); // Close sidebar if it's open
      }
  };
  ...
  return (
<>
    {/* <div id="responsive-overlay" class="active"></div> */}

    <div id="sidebarMenu" className="sidebar collapse d-lg-block" ref={sidebarRef}>
      <aside class="app-sidebar sticky" id="sidebar">
        ...
        <div className="main-sidebar simplebar-scrollable-x d-lg-block " id="sidebar-scroll" data-simplebar="init">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open active">
                      ...
                      <ul class="main-menu active">
                        <li class="slide active">
                          <Link to="/dashboard" class="side-menu__item" onClick={() => handleSidebarItemClick()}>
                        ...
                        <li class="slide">
                          <Link to="/add-new-entry" class="side-menu__item" onClick={() => handleSidebarItemClick()}>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 side-menu__icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <li class="slide">
                          <Link to="/scan-gallary" class="side-menu__item" onClick={() => handleSidebarItemClick()}>
                        ...
                        <li class="slide">
                          <Link to="/add-new-grievance" class="side-menu__item" onClick={() => handleSidebarItemClick()}>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 side-menu__icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <li class="slide">
                          <Link to="/all-grievance-list" class="side-menu__item" onClick={() => handleSidebarItemClick()}>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 side-menu__icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <li class="slide">
                          <Link to="/completed-grievance" class="side-menu__item" onClick={() => handleSidebarItemClick()}>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 side-menu__icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <li class="slide">
                          <Link to="/in-progress-grievance" class="side-menu__item" onClick={() => handleSidebarItemClick()}>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 side-menu__icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                              <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 0 1 1.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 0 0-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a1.125 1.125 0 0 1-1.125-1.125v-9.25m12 6.625v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H9.75"></path>
                            </svg>
                        ...
                        <li class="slide">
                          <Link to="/rejected-grievance" class="side-menu__item" onClick={() => handleSidebarItemClick()}>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 side-menu__icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <li className={`slide has-sub ${isOpen ? 'open' : ''}`}>
                          ...
                          {isOpen && (
                            <ul className="slide-menu child1" style={{ position: 'relative', left: '0px', top: '0px', margin: '0px', transform: 'translate3d(8px, 144px, 0px)', display: 'block', boxSizing: 'border-box' }} data-popper-placement="top">
                              <li className="slide" onClick={() => handleSidebarItemClick()}>
                        ...
                        <li class="slide">
                          <Link to="/add-user" class="side-menu__item" onClick={() => handleSidebarItemClick()}>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 side-menu__icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
